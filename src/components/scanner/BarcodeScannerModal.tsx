        ...
        <div className="mt-5 space-y-5 text-xs">
          ...
          {scannedProduct && (
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-4 animate-scale-in">
              ...
              {/* Lot & Expiry FIFO Assignment Form */}
              <div className="p-3 bg-white border border-slate-200/80 rounded-xl space-y-2.5 shadow-2xs">
                <div className="flex items-center justify-between text-[11px] font-bold text-slate-700">
                  <span className="flex items-center space-x-1">
                    <Layers className="w-3.5 h-3.5 text-amber-700" />
                    <span>Stock Lot & Expiry Intake (FIFO)</span>
                  </span>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-2.5 py-1.5 bg-slate-50 border border-slate-200 rounded-lg font-mono text-xs font-semibold text-slate-800 focus:bg-white focus:outline-none focus:ring-1 focus:ring-slate-900"
                    />
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold text-slate-500 mb-0.5">
              ...
              {matchingOpenPO ? (
                <button
                  ...
                  className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl transition text-xs flex items-center justify-center space-x-1.5 shadow-2xs cursor-pointer active:scale-95"
                >
